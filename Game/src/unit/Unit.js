...
define(["require", "exports", '../tasks/BlackBoard', '../tasks/composite/Sequence', '../tasks/actions/Idle', '../tasks/actions/MoveTo', '../tasks/actions/RandomLocation', '../tasks/actions/FollowPointRelativeToTarget', '../util/PlayerManager'], function (require, exports, BlackBoard, Sequence, Idle, MoveTo, RandomLocation, FollowPointRelativeToTarget, PM) {
