...
//Screens
var MainMenuScreen = require('./screens/MainMenuScreen');
'use strict';
var Game = (function () {
    function Game(isServer) {
        ...
        this.preload = function () {
            _this.game.load.image('normal', 'Game/img/normal_button.png');
            _this.game.load.image('war', 'Game/img/war_button.png');
            _this.game.load.image('house', 'Game/img/house.png');
            _this.game.load.image('farm', 'Game/img/farm.png');
            _this.game.load.image('capitol', 'Game/img/capitol.png');
            _this.game.load.image('barracks', 'Game/img/barracks.png');
            _this.game.load.image('mine', 'Game/img/mine.png');
            _this.game.load.image('keep', 'Game/img/capitol.png');
            _this.game.load.image('flag', 'Game/img/flag.png');
            _this.game.load.image('buildBarracks', 'Game/img/button_barracks.png');
            _this.game.load.image('buildHouse', 'Game/img/button_house.png');
            _this.game.load.image('buildFarm', 'Game/img/button_farm.png');
            _this.game.load.image('buildMine', 'Game/img/button_mine.png');
            _this.game.load.image('buildCancel', 'Game/img/button_cancel.png');
            _this.game.load.image('buildKeep', 'Game/img/button_keep.png');
            _this.game.load.spritesheet('mainMenuButtons', 'Game/img/MainMenuButtons.png', 100, 50);
            _this.game.stage.backgroundColor = '#DDDDDD';
            _this.game.stage.disableVisibilityChange = true; //Apparently turns off pausing while in the background...
        };
        ...
        this.changeScreen = function (screen) {
            if (_this.currScreen !== null)
                _this.currScreen.destroy();
            _this.currScreen = screen;
            _this.currScreen.start();
        };
