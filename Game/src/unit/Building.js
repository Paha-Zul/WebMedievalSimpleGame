...
define(["require", "exports", './Unit', '../tasks/actions/TakeResource', '../tasks/actions/MoveTo', '../tasks/actions/GetColony', '../tasks/actions/GetClosestDropoff', '../tasks/actions/GiveResource', '../tasks/composite/Sequence'], function (require, exports, Unit, TakeResource, MoveTo, GetColony, GetClosestDropoff, GiveResource, Sequence) {
    /**
