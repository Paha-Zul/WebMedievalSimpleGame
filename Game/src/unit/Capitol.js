...
define(["require", "exports", './Unit', './Peasant', './House', './Farm', './Mine', './Keep', './Barracks', '../util/PlayerManager'], function (require, exports, _Unit, _Peasant, _House, _Farm, _Mine, _Keep, _Barracks, PM) {
